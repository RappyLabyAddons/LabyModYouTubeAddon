...
public class ViewModule extends SimpleModule {
    ...
    public String getDisplayValue() {
        return Util.getViews(Main.channelId, Main.apiKey);
    }
    ...
    public String getDescription() {
        return "Displays the current view count of the channel-id provided in the addon settings.";
    }
